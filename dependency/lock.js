...
function lock() {
  ...
  fs.writeFileSync(path.resolve(DIR, './package-lock-pretty.json'), pretty, 'utf-8');
  ...
  fs.writeFileSync(path.resolve(DIR, './package-lock-core.json'), core, 'utf-8');
  ...
  fs.writeFileSync(path.resolve(DIR, './package-lock-core-report.json'), report, 'utf-8');
